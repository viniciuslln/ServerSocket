...
${OBJECTDIR}/ClientHandler.o: ClientHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClientHandler.o ClientHandler.cpp
...
${OBJECTDIR}/ServerManager.o: ServerManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ServerManager.o ServerManager.cpp
